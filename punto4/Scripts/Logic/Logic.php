...
if (is_numeric($_POST["PlanetaG"])) {
        ...
        if (isset($planetas[$index])) {
            $temp_toReturn = $planetas[$index]["nombre"];
            header("Location:../Views/PlanetasGravedad/Resultado.php?element=".$temp_toReturn."&id=".$index);
        } else {
            ...
            foreach ($planetas as $key => $planeta) {
                if ($planeta["nombre"] == $names) {
                    header("Location:../Views/PlanetasGravedad/Resultado.php?element=".$planeta["nombre"]."&id=".$key);
                    $found = true;
                    break;
                }
            }
